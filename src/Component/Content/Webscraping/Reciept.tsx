            ...
            <div className='d-flex justify-content-between align-items-center row'>
                ...
                <div className='d-flex justify-content-center align-items-center col-lg-7'>
                    ...
                    <div className='input-group mx-1'>
                        ...
                        <input type="text" className="form-control text-center" value={state.Name_test} onChange={(e) => { dispatch({ type: "setstate", payload: { name: "Name_test", value: e.target.value } }) }} />
                    </div>
                </div>

...
const Personel = () => {
    ...
    const initials = {
        personel_infomation: [{ img: watd, imageCrop: watd, name: "Apinut Kaewmunee", position: "Engineering", contact: "0819635567" },
        { img: watd, imageCrop: watd, name: "Api Kaewm", position: "Eng", contact: "0819635567" }],
        edit_Personel: false,
    }

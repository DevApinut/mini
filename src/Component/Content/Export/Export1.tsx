...
export const ExcelExport = (props: any) => {
    ...
    props.Personal_Infomation.map((data: any, index: number) => {
        ...
        worksheet.getCell('D71').border = { top: { style: 'thin' }, bottom: { style: 'thin' } }
        worksheet.getCell('E71').border = { top: { style: 'thin' }, bottom: { style: 'thin' } }
        ...
        worksheet.getCell(`C${(71 - result1.length - 6)}`).border = { right: { style: 'thin' }, left: { style: 'thin' },bottom:{ style: 'thin' } }
        ...
        if (props.Detail_Work[0].type_order == "หมายเลขใบสั่ง") {
            ...
            worksheet.getCell(`P${(71 - result1.length - 3)}`).border = { right: { style: 'thin' },bottom:{ style: 'thin' } }
            ...
            worksheet.getCell(`P${(71 - result1.length - 1)}`).border = { right: { style: 'thin' },bottom:{ style: 'thin' } }
        ...
        worksheet.getCell('C66').border = { left: { style: 'thin' }, top: { style: 'thin' }, bottom: { style: 'thin' } }
        worksheet.getCell('C67').border = { left: { style: 'thin' }, top: { style: 'thin' }, bottom: { style: 'thin' } }
        worksheet.getCell('C68').border = { left: { style: 'thin' }, top: { style: 'thin' }, bottom: { style: 'thin' } }
        worksheet.getCell('C69').border = { left: { style: 'thin' }, top: { style: 'thin' }, bottom: { style: 'thin' } }
        worksheet.getCell('C70').border = { left: { style: 'thin' }, top: { style: 'thin' }, bottom: { style: 'thin' } }
        worksheet.getCell('C71').border = { left: { style: 'thin' }, top: { style: 'thin' }, bottom: { style: 'thin' } }
        worksheet.getCell('R66').border = { right: { style: 'thin' }, bottom: { style: 'thin' }, }
        worksheet.getCell('R67').border = { right: { style: 'thin' }, bottom: { style: 'thin' }, }
        worksheet.getCell('R69').border = { right: { style: 'thin' }, bottom: { style: 'thin' }, }
        worksheet.getCell('R70').border = { right: { style: 'thin' }, bottom: { style: 'thin' }, }
        worksheet.getCell('R71').border = { right: { style: 'thin' }, bottom: { style: 'thin' }, }
        worksheet.getCell('Z64').border = { right: { style: 'thin' },  top: { style: 'thin' } }
